...
12. **Structure (Experienced)** — Contact → Experience → Skills → Projects → Education. At the Senior tier (Rule 15), an Executive Summary (Rule 33) inserts between Contact and Experience.
...
15. **Page Length (Senior)** — Max 2 pages. Roles older than roughly 10–15 years lose their bullets entirely — keep just the org, title, and dates — unless a specific bullet there still directly matches the target role.
...
33. **Executive Summary (Senior)** — For Senior-tier CVs (Rule 15), open with a short summary before Experience: the target role or field, one sentence of scope or context, and 2–4 of the strongest accomplishments compressed to a phrase each. Skip it at Early Career or standard Experienced tiers — the space is better spent on Experience there.
