...
% -14pt here vs. -4pt in CV - Template.tex is intentional, not drift:
% it compensates for this document's extra vspace before the date/
% recipient block below, keeping the two headers visually aligned.
\vspace{-14pt}
\normalsize
\kern 1.0pt
\vspace{2pt}
