...
% Compact list -- used by Skills & Languages
...
% Dash sub-bullets -- one level deeper than a normal entry (e.g. inside Education)
...
% A bullet with a bold leading label (Skills, Languages)
\newcommand{\resumeSubItem}[2]{\resumeItem{\textbf{#1} #2}}
% Two-line entry: Org/Institution + Location, then Role + Date
% (see COMMAND REFERENCE below for which sections use this)
...
%      Bullet list used for Skills / Languages rows.
%
...
%  it IS the full master CV. Page count changes whenever entries
%  change; verify by compiling. When a shorter version is needed
%  (Rule 14/15), decide what to include directly from the knowledge
%  base and the rules -- there is no fixed derivation procedure.
%
%  CONTENT DISCLAIMER: the "Claude" entries below exist to demonstrate
%  command usage only. Wording is illustrative, not a rule-compliance
%  reference -- see `CV - Rules.md` for the actual CV rules. Do not
%  copy phrasing patterns from this file into a real CV.
% ============================================================
...
% ---------------- EXPERIENCE ----------------
% Renamed from the original "Model Releases" label to match the generic
% vocabulary CV - Rules.md Rules 8/12 use for section order (Contact ->
% Experience -> Skills -> Projects -> Education). Entry content unchanged.
\section{Experience}
...
% ---------------- SKILLS ----------------
% Renamed from the original "Technical Capabilities" label to match
% CV - Rules.md Rule 12's vocabulary; content unchanged.
\section{Skills}
...
% ---------------- PROJECTS & RESEARCH ----------------
% Ordered per CV - Rules.md Rule 10.
...
% NOTE: third-party pre-deployment evaluation lives once, under
% Certifications below -- see CV - Rules.md's "On duplication."

\projectSubheadingListEnd

% ---------------- CERTIFICATIONS ----------------
% Renamed from the original "Safety, Evaluation & Compliance" label to
% match the Knowledge Base Example's "Certifications & Workshops"
% section and CV - Rules.md's vocabulary; content unchanged.
...
% ---------------- LEADERSHIP ----------------
% Renamed from the original "Industry Initiatives" label to match the
% Knowledge Base Example's "Leadership & Extracurricular" section;
% content unchanged.
\section{Leadership}
\projectSubheadingListStart
...
% ---------------- EDUCATION ----------------
% Renamed from the original "Training & Development" label to match
% CV - Rules.md Rules 8/12's vocabulary and the Knowledge Base Example's
% "Education" section; content unchanged.
\section{Education}
\resumeSubHeadingListStart
% Uses a distinct fact (RLHF cadence) from the Constitutional AI facts
% under Projects & Research above -- see CV - Rules.md's "On duplication."
\resumeSubheading
  {Anthropic, PBC}{San Francisco, CA}
