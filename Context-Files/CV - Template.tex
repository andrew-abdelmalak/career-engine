...
%  are the drafting reference for CV - Rules.md Rule 1.
% ============================================================
...
%  base and the rules (density, impact, relevance).
%
...
% ---------------- SUMMARY ----------------
\section{Summary}
\noindent Flagship AI assistant with 5+ years in continuous production across Anthropic's model lineup, spanning pretraining through deployment. Brought agentic coding from research preview to general availability as \textbf{Claude Code}; open-sourced \textbf{Model Context Protocol}, since adopted industry-wide beyond Anthropic's own models; established \textbf{Constitutional AI} as the alignment method underpinning every release since.
